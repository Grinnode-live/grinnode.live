...
- _Orphan block_ :  Not part of the longest valid chain, and the parent of the orphan block is unknown. [3]
	
- _Stale block_ : Well-formed block which is no longer part of the longest (difficulty-wise) and well-formed blockchain. [4]
...
- Between the block _949474_ and _949510_ - **REORG depth of 27 blocks**:
	...
	[Output n°1](https://grinscan.net/block/0000ada472a31ed7b0054e16a565427e8ec8d36e8edae0f571c50c3bcab9ac51#o0) | [Output n°1](https://grinscan.net/block/000261a48947f69bf38e4edf33b7efa18cd3ecd24a7a8699ec70ebe45e373768#o1)
	[Output n°2](https://grinscan.net/block/0000ada472a31ed7b0054e16a565427e8ec8d36e8edae0f571c50c3bcab9ac51#o1) | [Output n°2](https://grinscan.net/block/000261a48947f69bf38e4edf33b7efa18cd3ecd24a7a8699ec70ebe45e373768#o2)
	[Attacker's Txs Kernel in stale block](https://grinscan.net/block/0000ada472a31ed7b0054e16a565427e8ec8d36e8edae0f571c50c3bcab9ac51#k0) | [Attacker's Txs Kernel in REORG block](https://grinscan.net/block/000261a48947f69bf38e4edf33b7efa18cd3ecd24a7a8699ec70ebe45e373768#k0)
...
- Between the block _949636_ and _949678_ - **REORG depth of 43 blocks**:
	...
	[Output n°2](https://grinscan.net/block/0002027a030163d06dd9127b798c6fff17e19204f7e1ebd415313ca712810d81#o1) | [Output n°2](https://grinscan.net/block/0000a70697eaabc770ee771eaf15c433dcda183555cc5fb6688f13c543d88106#o2)
...
- Between the block _949715_ and _949737_ - **REORG depth of 23 blocks**:
	...
	Malicious tx confirmed in stale block | Malicious tx confirmed in REORG block
	------------ | -------------
	[Confirmed in stale Block n°949720](https://grinscan.net/block/0001170468d147e75492d9b1dbf3c8bee3869fa88c4f33508b7ddda3be0f2464) | [Confirmed in REORG Block n° 949718](https://grinscan.net/block/00025b694866287b64b04f3e021a6800356b74313e8fee72f1788a1009fd11b5)
	...
	[Output n°2](https://grinscan.net/block/0001170468d147e75492d9b1dbf3c8bee3869fa88c4f33508b7ddda3be0f2464#o9) | [Output n°2](https://grinscan.net/block/00025b694866287b64b04f3e021a6800356b74313e8fee72f1788a1009fd11b5#o2)
	[Attacker's Txs Kernel in stale  block](https://grinscan.net/block/0001170468d147e75492d9b1dbf3c8bee3869fa88c4f33508b7ddda3be0f2464#k3) | [Attacker's Txs Kernel in REORG block](https://grinscan.net/block/00025b694866287b64b04f3e021a6800356b74313e8fee72f1788a1009fd11b5#k1)
...
We suggest every user to run their own node (Grin-Node, Grin++) whenever possible (short time, long-term, does not matter). Make sure you have 3414 is open if you wish to have inbound connections, instead of only outbound.
...
## Sources
  ...
  - [2] : https://blog.honeyminer.com/whats-a-blockchain-reorg/
  - [3] : https://en.bitcoin.it/wiki/Orphan_Block
  - [4] : https://en.bitcoin.it/wiki/Vocabulary#Stale_Block
